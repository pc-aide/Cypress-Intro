...
|3|Mocha|<ins>Framework</ins><br/><br/><ins>it block</ins><br/>Test Case individual<br/>`it('test case', () => {`<br/>`    // cypress command here`<br/>`});`<br/><br/>it.only - run only this block||<img src="https://i.imgur.com/JdODL0S.png">|
