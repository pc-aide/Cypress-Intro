...
|8|Test Runner|<ins>Components of the Test Runner</ins><br/>1. Test Status Menu<br/>&ens;`it()` individual test block<br/>2. Command Log<br/>3. Url Preview<br/>4. Viewport Sizing<br/>5. App preview||<img src="https://i.imgur.com/mvbvVtZ.png">|
